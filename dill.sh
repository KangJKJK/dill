...
# 사용자에게 선택지 제공
read -p "${RED}입금주소와 출금주소는 같아야 편합니다. 설치진행 전에 하나의 wallet을 준비해두세요${NC}"
while true; do
...
read -p "${GREEN}Galxe 퀘스트를 완료하셨습니까? (계속하려면 엔터를 누르세요)${NC}"
